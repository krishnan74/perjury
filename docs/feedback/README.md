...
|---|---|---|
| Chainlink | [chainlink.md](chainlink.md) | CRE Confidential Workflows (TEE handler, Vault DON, Confidential HTTP, on-chain reports) and VRF v2.5 |
| ENS | [ens.md](ens.md) | ENSv2 Enhanced Access Control, Permissioned Resolvers, direct-to-contract registration |
| The Graph | [the-graph.md](the-graph.md) | Gateway, Subgraph MCP, Messari standardized schemas, `_meta` provenance, cross-deployment corroboration |
